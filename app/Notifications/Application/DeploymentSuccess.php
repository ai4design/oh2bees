...
class DeploymentSuccess extends Notification implements ShouldQueue
{
    ...
    public function toMail(): MailMessage
    {
        ...
        if ($pull_request_id === 0) {
            $mail->subject("Oh2Bees: New version is deployed of {$this->application_name}");
        } else {
            $fqdn = $this->preview->fqdn;
            $mail->subject("Oh2Bees: Pull request #{$pull_request_id} of {$this->application_name} deployed successfully");
        }
    ...
    {
        if ($this->preview) {
            $message = 'Oh2Bees: New PR'.$this->preview->pull_request_id.' version successfully deployed of '.$this->application_name.'
...
';
            ...
            $message = 'Oh2Bees: New version successfully deployed of '.$this->application_name.'
