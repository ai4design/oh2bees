...
class StatusChanged extends Notification implements ShouldQueue
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $fqdn = $this->fqdn;
        $mail->subject("Oh2Bees: {$this->resource_name} has been stopped");
    ...
    {
        $message = 'Oh2Bees: '.$this->resource_name.' has been stopped.

';
        $message .= '[Open Application in Oh2Bees]('.$this->resource_url.')';
