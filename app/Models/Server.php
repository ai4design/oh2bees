...
respond 404
                ...
                $conf =
                    "# This file is automatically generated by Oh2Bees.\n".
...
$schema://$host {
    ...
    public function validateDockerEngine($throwError = false)
    {
        ...
        $this->settings->save();
        $this->validateOh2BeesNetwork(isSwarm: false, isBuildServer: $this->settings->is_build_server);
    ...
    public function validateDockerSwarm()
    {
        ...
        $this->settings->is_usable = true;
        $this->settings->save();
        $this->validateOh2BeesNetwork(isSwarm: true);
    ...
    public function validateOh2BeesNetwork($isSwarm = false, $isBuildServer = false)
    {
        if ($isBuildServer) {
            return;
        }
