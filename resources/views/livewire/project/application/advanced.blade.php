        ...
        <div class="flex flex-col gap-1 pt-4">
            ...
            @if ($application->build_pack === 'dockercompose')
                ...
                <x-forms.checkbox instantSave id="application.settings.is_raw_compose_deployment_enabled"
                    ...
                    helper="WARNING: Advanced use cases only. Your docker compose file will be deployed as-is. Nothing is modified by Oh2Bees. You need to configure the proxy parts. More info in the <a class='underline dark:text-white' href='https://coolify.io/docs/knowledge-base/docker/compose#raw-docker-compose-deployment'>documentation.</a>" />
            @endif
            ...
            @if ($application->build_pack === 'dockercompose')
                ...
                <x-forms.checkbox instantSave id="application.settings.connect_to_docker_network"
                    ...
                    helper="By default, you do not reach the Oh2Bees defined networks.<br>Starting a docker compose based resource will have an internal network. <br>If you connect to a Oh2Bees defined network, you maybe need to use different internal DNS names to connect to a resource.<br><br>For more information, check <a class='underline dark:text-white' target='_blank' href='https://coolify.io/docs/knowledge-base/docker/compose#connect-to-predefined-networks'>this</a>." />
            @endif
