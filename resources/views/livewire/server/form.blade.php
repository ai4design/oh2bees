        ...
        <div class="flex gap-2">
            ...
            @if ($server->id === 0)
                <x-modal-confirmation buttonTitle="Save" title="Change Localhost" action="submit">
                    You could lose a lot of functionalities if you change the server details of the server where Oh2Bees
                    is
                    ...
                    @if (!$server->isLocalhost())
                        ...
                        <div class="flex items-center gap-1 pt-6">
                            ...
                            <x-helper class="inline-flex"
                                helper="If you are using Cloudflare Tunnels, enable this. It will proxy all SSH requests to your server through Cloudflare.<br><span class='dark:text-warning'>Oh2Bees does not install or set up Cloudflare (cloudflared) on your server.</span>" />
                        </div>
